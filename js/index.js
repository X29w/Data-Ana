...
(function () {
  ...
  var option = {
    ...
    xAxis: [{
      type: 'category',
      data: ["Politics", "Education", "History", "Medical", "Entertainment", "Social", "Finance"],
      axisTick: {
        alignWithLabel: true
      },
      // 修改刻度标签，相关样式
...
(function () {
  ...
  var value = ["120", "50", "90"];
  var indicator = [
      {max: "200", name: "Android"},
      {max: "200", name: "iOS"},
      {max: "200", name: "Harmony"}
   ];
  option = {
